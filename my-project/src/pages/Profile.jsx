...
export default function Profile() {
  ...
  const [showListingsError, setShowListingsError] = useState(false); // Added state
  const [userListings, setUserListings] = useState([]); // Added state for user listings
  ...
  const handleShowListings = async () => {
    try {
      ...
      setUserListings(data); // Set the retrieved listings
    } catch (error) {
      setShowListingsError(true);
    }
  };
